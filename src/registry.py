...
def register_all_components():
    """
    Register all component implementations at startup.

    This function is called once when the application starts (in main.py)
    to register all available component implementations with the registry.

    New components should be added here when implemented.
    """
